...
class ZeroScann():
    ...
    def scan(self):
        ...
        parser = argparse.ArgumentParser(prog="Tuanswam.py", description="Simple Find Shell in Website")
 ...
 # ================================== #
 # Shell Scanner                      #
 # Code by Anon_R7                 #\033[0m
 # Tools : Scan Shell Website            #
 # Email   : peretasarmy@gmail.com  #
 # ================================== #
              """
        return info
    print(banner())
